    ...
    <form action={handleSubmit} className="space-y-8">
      ...
      <div className="bg-zinc-50 p-6 rounded-3xl border border-zinc-200 shadow-inner">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="w-24 h-24 bg-zinc-200 rounded-full overflow-hidden border-4 border-white shadow-md">
      ...
      <button disabled={loading} type="submit" className="w-full bg-black text-white font-bold py-5 rounded-2xl hover:scale-[1.02] active:scale-95 transition-all shadow-xl disabled:bg-zinc-400">
