    ...
    <div className="min-h-screen w-full bg-black flex justify-center items-center p-0 md:p-4 font-sans overflow-hidden select-none">
      ...
      <div className="relative h-screen md:h-[850px] w-full max-w-[430px] flex flex-col text-white shadow-[0_0_120px_rgba(0,0,0,1)] md:rounded-[4.5rem] border-0 md:border-[12px] border-zinc-900 bg-black overflow-hidden group">
        <div className="absolute inset-0 z-0">
          {profile.video_bg_url && <video autoPlay muted loop playsInline className="h-full w-full object-cover opacity-60 contrast-125 brightness-[0.4]"><source src={profile.video_bg_url} type="video/mp4" /></video>}
        ...
        {/* 2. RE-POSITIONED HEADSHOT (LIFTED TO TOP 18%) */}
        <main className="absolute inset-x-0 bottom-0 top-[18%] z-10 pointer-events-none flex justify-center overflow-hidden">
            {profile.avatar_url && (
